...
public class ShowStudent extends javax.swing.JFrame {
    ...
    public ShowStudent() {
     ...
     private void fillStudentTable(){
        ...
        DefaultTableModel StudentTable = (DefaultTableModel)ShowStudentTable.getModel();
        SettingTable.showStudentTable(StudentTable);
    }
    ...
    private void initComponents() {
        ...
        ShowStudentTable.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ShowStudentTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "First Name", "Last Name", "e-mail", "Gender", "Phone Number"
            }
        ) {
        ...
        ShowStudentTable.setRowHeight(35);
        ShowStudentTable.setSelectionBackground(new java.awt.Color(204, 204, 255));
        jScrollPane1.setViewportView(ShowStudentTable);
        ...
        ShowStudent.setBackground(new java.awt.Color(153, 153, 255));
